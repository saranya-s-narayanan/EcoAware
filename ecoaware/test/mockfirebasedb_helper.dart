...
class MockDatabaseReference extends Mock implements DatabaseReference {
  ...
  Query orderByChild(String key) {
    return MockQuery._(this,  mockOrderByChild: key);
  }
...
class MockQuery extends Mock implements Query {
  MockQuery._(DatabaseReference reference, {required String mockOrderByChild});

  @override
  String get mockOrderByChild => mockOrderByChild;
}